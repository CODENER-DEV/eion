...
export class LoginPage implements OnInit {
  ...
  /**
   * ngOnInit (Lifecycle event) - get permissions to show local notifications and register fiels to validate
   * @returns {Object} granted permission and controls of form
   */
  ngOnInit() {
